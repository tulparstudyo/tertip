/** Inline Tabler SVG strings for non-Vue contexts (e.g. TipTap node views) */
function tablerInlineSvg(paths, strokeWidth = 1.75) {
...
export const TABLER_ICON_BOOKMARK = tablerInlineSvg(
  '<path d="M18 7v14l-6 -4l-6 4v-14a4 4 0 0 1 4 -4h4a4 4 0 0 1 4 4" />',
);

export const TABLER_ICON_PHOTO = tablerInlineSvg(
...
export const TABLER_ICON_MESSAGE = tablerInlineSvg(
  '<path d="M3 20l1.3 -3.9c-2.324 -3.437 -1.426 -7.872 2.1 -10.374c3.526 -2.501 8.59 -2.296 11.845 .48c3.255 2.777 3.695 7.266 1.029 10.501c-2.666 3.235 -7.615 4.215 -11.574 2.293l-4.7 1" />',
);

export const TABLER_ICON_PAPERCLIP = tablerInlineSvg(
